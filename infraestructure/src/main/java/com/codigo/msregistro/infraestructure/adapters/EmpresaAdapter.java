...
public class EmpresaAdapter implements EmpresaServiceOut {
    ...
    private EmpresaEntity getEntityUpdate(ResponseSunat sunat, EmpresaEntity personaActualizar){
        personaActualizar.setRazonSocial(sunat.getRazonSocial());
        personaActualizar.setNomComercial(sunat.getRazonSocial());
